...
motor_speed = 0
def forward():
    PWM.setMotorModel(800, 800, 800, 800)  # Forward
    set_led("all", [0,20,0])
    print("The car is moving forward")
    time.sleep(sleep_time)
def backward():
    PWM.setMotorModel(-800, -800, -800, -800)  # Back
    print("The car is going backwards")
    time.sleep(sleep_time)
def left():
    PWM.setMotorModel(-1200, -1200, 1600, 1600)  # Left
    print("The car is turning left")
    set_led("left", [0,20,0])
    time.sleep(sleep_time)
def right():
    PWM.setMotorModel(1600, 1600, -1200, -1200)  # Right
    set_led("right", [0,20,0])
